---
title: '`r knitr::include_graphics("images/nacho_hex.png", dpi = 250)`'
...
include_graphics("images/nacho_hex.png")
```
</div>
...
# `r include_graphics("images/nacho_hex.png", dpi = 200)` | (**NA**nostring quality **C**ontrol das**H**b**O**ard) {.flexbox .vcenter}
...
# Let's play a bit with | `r include_graphics("images/nacho_hex.png", dpi = 200)` {.flexbox .vcenter}
...
# `r include_graphics("images/carot_hex.png", dpi = 200)` | (**C**entralised and **A**utomated **R**ep**o**rting **T**ools ) {.flexbox .vcenter}

---
title: "![NACHO](images/nacho_hex.png){width=200px}"
...
![](images/nsolver_01.png){width=600px}

## NanoString™ nCounter® nSolver™

![](images/nsolver_02.png){width=600px}
...
<div class="columns-2">
  <div class="columns-2">
  ![](images/nsolver_03.png){width=200px}
  
  ![](images/nsolver_04.png){width=200px}
  </div>

  <div class="columns-2">
  ![](images/nsolver_05.png){width=200px}
  
  ![](images/nsolver_06.png){width=200px}
  </div>
</div>
...
![](images/nacho_hex.png){width=100px}
</div>
<div style="float: right; width: 85%;">
![](images/nacho_article.png)
</div>

![](images/nacho_website.png)


# ![NACHO](images/nacho_hex.png){width=300px} | (**NA**nostring quality **C**ontrol das**H**b**O**ard) {.flexbox .vcenter}
...
# Let's play a bit with | ![NACHO](images/nacho_hex.png){width=300px} {.flexbox .vcenter}
...
```
![](images/nacho_app.png){width=600px}
...
# ![CARoT](images/carot_hex.png){width=300px} | (**C**entralised and **A**utomated **R**ep**o**rting **T**ools ) {.flexbox .vcenter}
